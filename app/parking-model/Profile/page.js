...
// The main component for the New Customer profile page.
const App = () => {
  ...
  // Renders the form UI.
  return (
    <div className="flex bg-[#2EC773] p-5 rounded-lg items-center justify-center font-display">
      <div className="bg-white rounded-xl shadow-lg p-6 w-full max-w-sm">
        ...
        <button
          ...
          className={`w-full mt-6 py-3 rounded-xl text-lg font-semibold transition-colors duration-200 ${
            isContinueEnabled
